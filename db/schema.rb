...
ActiveRecord::Schema.define(version: 20171028042416) do
  ...
  create_table "properties", force: :cascade do |t|
    ...
    t.string   "taxes_and_fees_restate"
    t.string   "taxes_and_fees_assessments"
    t.string   "taxes_and_fees_separate_tax_parcel"
    t.string   "taxes_and_fees_landlord_contesting"
    t.string   "taxes_and_fees_tenant_contesting"
    t.string   "taxes_and_fees_easements"
    t.string   "site_preparation_env_obligations"
    t.string   "site_preparation_env_termination_rights"
    t.string   "site_preparation_env_remediation"
    t.string   "site_preparation_env_permits_and_licenses"
    t.string   "construction"
    t.string   "construction_deadline"
    t.string   "construction_liens"
    t.string   "construction_approval_of_plans_and_specs"
    t.string   "use_clause"
    t.string   "use_exclusive_clause"
    t.string   "premises_tenant_rights"
    t.string   "premises_waste"
    t.string   "premises_initial_opening"
    t.string   "premises_recapture_clause"
    t.string   "premises_demolition"
    t.string   "premises_tenants_equipment_defined"
    t.string   "premises_ownership_and_removal"
    t.string   "premises_repairs"
    t.string   "premises_compliance_with_laws"
    t.string   "premises_surrender"
    t.string   "premises_inspection"
    t.string   "premises_insurance"
    t.string   "premises_destruction"
    t.string   "premises_total_taking"
    t.string   "premises_partial_taking"
    t.string   "premises_signs"
    t.string   "premises_utilities"
    t.string   "transfer_assignment_and_subletting"
    t.string   "transfer_leasehold_mortgage"
    t.string   "transfer_subordination"
    t.string   "transfer_estoppel_certificate"
    t.string   "remedies_rent_defaults"
    t.string   "remedies_landlord"
    t.string   "remedies_mitigation"
    t.string   "remedies_force_majeure"
    t.string   "remedies_dispute_resolution"
    t.string   "remedies_landlord_exoneration"
    t.string   "remedies_exculpation"
    t.string   "misc_notices"
    t.string   "misc_obligation"
    t.date     "lease_analysis_date"
    t.string   "lease_original_landlord"
    t.string   "lease_original_tenant"
    t.string   "lease_original_guarantor"
    t.integer  "lease_primary_term"
    t.date     "lease_rent_commencement_date"
    t.string   "lease_option_to_extend"
    t.string   "lease_delivery_of_the_premises"
    t.string   "lease_rent_abatement"
    t.decimal  "lease_percentage_rent"
    t.string   "lease_percentage_rent_exclusions"
    t.boolean  "lease_percentage_rent_exist"
    t.string   "survey"
    ...
    t.string   "taxes_and_fees_restate_rating"
    t.string   "taxes_and_fees_assessments_rating"
    t.string   "taxes_and_fees_separate_tax_parcel_rating"
    t.string   "taxes_and_fees_landlord_contesting_rating"
    t.string   "taxes_and_fees_tenant_contesting_rating"
    t.string   "taxes_and_fees_easements_rating"
    t.string   "site_preparation_env_obligations_rating"
    t.string   "site_preparation_env_termination_rights_rating"
    t.string   "site_preparation_env_remediation_rating"
    t.string   "site_preparation_env_permits_and_licenses_rating"
    t.string   "construction_rating"
    t.string   "construction_deadline_rating"
    t.string   "construction_liens_rating"
    t.string   "construction_approval_of_plans_and_specs_rating"
    t.string   "use_clause_rating"
    t.string   "use_exclusive_clause_rating"
    t.string   "premises_tenant_rights_rating"
    t.string   "premises_waste_ratingpremises_initial_opening_rating"
    t.string   "premises_recapture_clause_rating"
    t.string   "premises_demolition_rating"
    t.string   "premises_tenants_equipment_defined_rating"
    t.string   "premises_ownership_and_removal_rating"
    t.string   "premises_repairs_rating"
    t.string   "premises_compliance_with_laws_rating"
    t.string   "premises_surrender_rating"
    t.string   "premises_inspection_rating"
    t.string   "premises_insurance_rating"
    t.string   "premises_destruction_rating"
    t.string   "premises_total_taking_rating"
    t.string   "premises_partial_taking_rating"
    t.string   "premises_signs_rating"
    t.string   "premises_utilities_rating"
    t.string   "transfer_assignment_and_subletting_rating"
    t.string   "transfer_leasehold_mortgage_rating"
    t.string   "transfer_subordination_rating"
    t.string   "transfer_estoppel_certificate_rating"
    t.string   "remedies_rent_defaults_rating"
    t.string   "remedies_landlord_rating"
    t.string   "remedies_mitigation_rating"
    t.string   "remedies_dispute_resolution_rating"
    t.string   "remedies_landlord_exoneration_rating"
    t.string   "remedies_exculpation_rating"
