class Entities::TenancyByEntiretyController < ApplicationController
  ...
  def add_breadcrum
    ...
    if params[:entity_key] and @entity.present? and !@entity.new_record?
      add_breadcrumb ("<div class=\"pull-left\"><h4><a href=\"#{edit_entity_path(@entity.key)}\">Edit Tenancy By Entirety: <span id='edit-title-tbe'>#{@entity.name}</span></a></h4></div>").html_safe
    else
