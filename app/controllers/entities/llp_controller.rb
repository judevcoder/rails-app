  ...
  def partner
    ...
    if request.post?
      ...
      if @partner.save
        ...
        flash[:success] = "New Partner Successfully Created.</br><a href='#{entities_llp_partners_path( @entity.key )}'>Show in List</a>"
      ...
      if @partner.update(partner_params)
        ...
        @partner.save
        @partners = @partner.super_entity.partners
        flash[:success] = "The Partner Successfully Updated.</br><a href='#{entities_llp_partners_path( @entity.key )}'>Show in List</a>"
        return redirect_to entities_llp_partner_path( @entity.key, @partner.id )
        # return render layout: false, template: "entities/llp/partners"
      else
